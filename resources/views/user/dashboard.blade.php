	 ...
	 <div class="col-sm-7">
	 	...
	 	<table class="table table-hover table-sprite">
	 		...
	 		<tbody>
	 			<tr v-for="user in users">
	 				...
	 				<td width="10px"><a href="#" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-remove"></i> Eliminar</a></td>
	 			</tr>
	 		</tbody>
	 	</table>
	 	...
	 	<ul  class="list-group">
			...
			<li class="list-group-item">
				<button class="btn btn-primary" v-on:click="getWinner"><span class="glyphicon glyphicon-gift" aria-hidden="true"></span> Elegir Ganador</button> 
				<button v-model="winner" v-if="winnerflag" class="btn btn-success pull-right"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> Contactar</button>
			</li>
		</ul>
	 </div>	 
	 <div class="col-sm-5">
